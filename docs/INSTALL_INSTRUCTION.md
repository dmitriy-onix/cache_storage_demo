# Cache Storage Demo Installation guide
...
* How to run Cache Storage Demo application locally
* How to run Cache Storage Demo automatic tests
* How to build Cache Storage Demo application
...
Cache Storage Demo application supported on following platforms:
...
Before opening Cache Storage Demo project make sure that you have installed followed software on your Mac or PC:

* IDE (Android Studio or VSCode)
* Dart SDK
* Flutter SDK and Flutter plugin for IDE

When you sure you installed followed software follow steps to prepare Cache Storage Demo project to build.
...
To run Cache Storage Demo application locally on device follow steps:
...
Cache Storage Demo application is covered with **unit** and **widgets** tests.
...
## How to build and distribute Cache Storage Demo application using fastlane
